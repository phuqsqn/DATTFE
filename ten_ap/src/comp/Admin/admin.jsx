      ...
      <div className="SumPj">
        <div className="Sum__left">
          ...
          <div className="left__bottom">
            ...
            <div className="menu_left">
             <img src="https://th.bing.com/th/id/R.f91b60a4cbe2fa5fb7c8711e33ceacee?rik=QcHmCIK%2bui2sbg&pid=ImgRaw&r=0" alt="" /> <h2>Job</h2>
            </div>
            <div className="menu_left">
              ...
              <h2><Link to="/Admin/accounts">Accounts</Link></h2>
            </div>
            <div className="menu_left">
              <img
                ...
                alt=""
              />
              <h2><Link to={"/Admin/categories"}>ProJect</Link></h2>
            </div>
            <div className="menu_left">
              <img
                ...
                alt=""
              />
              <h2><Link to="/Admin/product">Products</Link></h2>
            </div>
          </div>
        </div>
